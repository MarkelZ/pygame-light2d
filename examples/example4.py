...
# Create layer
layer = lights_engine.graphics.make_layer(size=screen_res)  # THIS IS NEW!
...
while running:
    ...
    # Render the scene
    lights_engine.render_to_layer(layer)  # THIS IS NEW!

    # HERE YOU CAN DO ANY POSTPROCESSING YOU WANT WITH layer!
    # ...

    lights_engine.graphics.render(
        layer.texture, lights_engine.graphics.screen)  # THIS IS NEW!
